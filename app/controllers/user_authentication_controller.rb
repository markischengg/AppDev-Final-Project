class UserAuthenticationController < ApplicationController
  ...
  def homepage
    render({ :template => "user_authentication/user_homepage.html.erb" })
  end
  ...
  def create_cookie
    ...
    if user != nil
      ...
      if are_they_legit == false
        ...
        redirect_to("/user_homepage", { :notice => "Signed in successfully." })
      end
    else
  ...
  def update
    ...
    @user.first_name = params.fetch("query_first_name")
    @user.last_name = params.fetch("query_last_name")
    @user.tab = params.fetch("query_tab")
    @user.type = params.fetch("query_type")
